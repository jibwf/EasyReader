...
export function RewindIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M12.5 3C17.15 3 21.08 6.03 22.45 10.22L20.08 11C18.96 7.64 15.98 5.18 12.5 5.18V8.82L7.5 5.18V14.82L12.5 11.18V13C16.04 13 18.96 15.36 20.08 18.72L22.45 19.5C21.08 23.69 17.15 26.82 12.5 26.82C6.97 26.82 2.5 22.35 2.5 16.82C2.5 11.29 6.97 6.82 12.5 6.82V3Z" />
    </svg>
  );
}

export function FastForwardIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M11.5 26.82C6.85 26.82 2.92 23.79 1.55 19.6L3.92 18.82C5.04 22.18 8.02 24.64 11.5 24.64V21L16.5 24.64V15L11.5 18.64V16.82C7.96 16.82 5.04 14.46 3.92 11.1L1.55 10.32C2.92 6.13 6.85 3 11.5 3C17.03 3 21.5 7.47 21.5 13C21.5 18.53 17.03 23 11.5 23V26.82Z" />
    </svg>
  );
}
...
export function SpeedIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CloudDownloadIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
